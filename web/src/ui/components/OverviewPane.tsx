...
export function OverviewPane({ triggers, selectedEvent, onSelectEvent }: OverviewPaneProps) {
  ...
  return (
    <aside
      className="w-[360px] border-l border-border bg-bg flex flex-col overflow-y-auto p-4"
      ref={rootRef}
